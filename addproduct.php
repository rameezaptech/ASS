...
if(isset($_POST['addproduct'])){
    ...
    $insert_file = "INSERT INTO `products` (`title`, `category`, `description`, `images`) VALUES ('$pro_title', '$pro_cat', '$pro_des','$img_name')";
...
?>
  ...
  <textarea class="form-control" placeholder="description" name = "des" id="floatingTextarea"></textarea>
